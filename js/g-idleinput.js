...
function StartNewGame() {
  thisHouse = JSON.parse(
    JSON.stringify(HouseList[houseSelect.selectedIndex][1])
  );
  if (cheatMode) roomAt = roomSelect.selectedIndex + 1;
  else roomAt = 1;
  roomsPassed = 1;
  roomScore = 0;
  suppScore = 0;
  ...
  for (let i = 0; i < roomVisits.length; i++) roomVisits[i] = false;
