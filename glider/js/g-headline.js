...
function DrawRoomNumber() {
  ...
  if (roomsPassed > 99) shown = Math.floor(roomsPassed / 100);
  else {
    if (roomsPassed > 9) shown = Math.floor(roomsPassed / 10);
    else shown = roomsPassed;
  }
  TextFont("12px arial");
...
function UpdateBatteryEnergy() {
  ...
  TextFont("12px arial");
  if (theGlider.energy >= 1000) energy = "+++";
